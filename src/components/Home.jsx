...
//     setLevel(level);
//     navigate(`/quiz/${category}/${level}`); // Navigate with both category and level
//   };
...
const Home = () => {
  ...
  const handleCategorySelect = (category) => {
    setCategory(category);
    console.log("Category Selected: ", category); // Check category update
  };

  const handleLevelSelect = (level) => {
    setLevel(level);
    console.log("Level Selected: ", level); // Check level update
    if (category && level) {
